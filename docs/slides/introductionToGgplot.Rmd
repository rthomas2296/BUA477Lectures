---
title: "Introduction to ggplot: Visualizing amounts"
author:
    - name: "Roy Thomas"
...
.center[
```{r boxoffice-rot-axis-tick-labels, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 6, fig.asp = .85, dev = "svg"}
p_box_axrot <- 
